...
namespace MilovanaEosEditor.Old;

// LEGACY: the original single-window gallery/tagging UI, kept as a reference (see the XAML header).
// Its tagging + generate-map logic is the source material for the future Tag Images / Workflow tools.
public partial class LegacyTaggingView : Window
{
